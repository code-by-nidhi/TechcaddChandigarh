...
export type TestimonialCreate = Omit<Testimonial, keyof BaseEntity | 'avatar'>
export type TestimonialUpdate = Partial<TestimonialCreate>

/** Live against the Express API. */
export const testimonialsApi = createHttpResource<Testimonial, TestimonialCreate, TestimonialUpdate>(
  '/testimonials',
)
